...
// Récupération de l'ID de la demande via l'URL
...
// Récupération des demandes non encore traitées
...
<div class="flex justify-center items-center min-h-screen bg-gray-100 dark:bg-gray-900 transition-all duration-500">
    <div class="w-full max-w-xl p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg animate-fade-in">
        ...
        <form method="POST" action="create.php" class="space-y-4">
            ...
            <div>
                ...
                <select name="id_demande" id="id_demande" required class="w-full px-4 py-2 border rounded-md bg-gray-100 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 transition">
            ...
            <div>
                ...
                <input type="date" name="date_reception" id="date_reception" required value="<?= date('Y-m-d') ?>" class="w-full px-4 py-2 border rounded-md bg-gray-100 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 transition">
            </div>

            <!-- Montant total -->
            <div>
                <label for="montant_total" class="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Montant total (FCFA)</label>
                <input type="number" step="0.01" name="montant_total" id="montant_total" required class="w-full px-4 py-2 border rounded-md bg-gray-100 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 transition">
            </div>

            <!-- Montant payé -->
            <div>
                <label for="montant_paye" class="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Montant payé (FCFA)</label>
                <input type="number" step="0.01" name="montant_paye" id="montant_paye" required class="w-full px-4 py-2 border rounded-md bg-gray-100 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 transition">
            </div>

            <!-- Type de réparation -->
            <div>
                <label for="type_reparation" class="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Type de réparation</label>
                <select name="type_reparation" id="type_reparation" class="w-full px-4 py-2 border rounded-md bg-gray-100 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 transition">
            ...
            <div>
                ...
                <select id="id_technicien" name="id_technicien" required class="w-full px-4 py-2 border rounded-md bg-gray-100 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 transition">
